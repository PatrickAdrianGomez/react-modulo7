...
import { UserDialog, UserFilter, UserHeader, UserTabla, type UserActionState } from '../../components';
import { useEffect, useState } from 'react';
import type { UserFilterDoneType, UserStatus, UserType } from '../../components/users/type';
...
export const UsersPage = () => {
    ...
    const { showAlert } = useAlert();
      ...
      const handleDone = async (id: number, status:  UserStatus) => {
        try {
